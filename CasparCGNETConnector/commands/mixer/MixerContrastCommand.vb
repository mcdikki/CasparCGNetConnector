...
Public Class MixerContrastCommand
    ...
    Private Sub InitParameter()
        ...
        addParameter(New CommandParameter(Of Single)("contrast", "The contrast value of the layer", 0.0, False))
    ...
    Public Overrides Function getCommandString() As String
        Dim cmd As String = "MIXER " & getDestination(getParameter("channel"), getParameter("layer")) & " CONTRAST"

        cmd = cmd & " " & DirectCast(getParameter("contrast"), CommandParameter(Of Single)).getValue
