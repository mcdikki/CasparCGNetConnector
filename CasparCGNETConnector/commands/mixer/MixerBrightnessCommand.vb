...
Public Class MixerBrightnessCommand
    ...
    Public Sub New(ByVal channel As Integer, ByVal layer As Integer, ByVal brightness As Single, Optional ByVal duration As Integer = 0, Optional ByVal tween As CasparCGUtil.Tweens = CasparCGUtil.Tweens.linear)
        MyBase.New("MIXER BRIGHTNESS", "Changes the brightness of the specified layer. The value is a float between 0 and 1")
        InitParameter()
        ...
        DirectCast(getParameter("brightness"), CommandParameter(Of Single)).setValue(brightness)
    ...
    Private Sub InitParameter()
        ...
        addParameter(New CommandParameter(Of Single)("brightness", "The brightness value of the layer", 0.0, False))
    ...
    Public Overrides Function getCommandString() As String
        Dim cmd As String = "MIXER " & getDestination(getParameter("channel"), getParameter("layer")) & " BRIGHTNESS"

        cmd = cmd & " " & DirectCast(getParameter("brightness"), CommandParameter(Of Single)).getValue
