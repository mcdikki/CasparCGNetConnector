...
Public Class MixerBrightnessCommand
    ...
    Public Overrides Function getCommandString() As String
        ...
        cmd = cmd & " " & DirectCast(getCommandParameter("brightness"), CommandParameter(Of Single)).getValue
    ...
    Public Function getBrightness() As Single
        Dim param As CommandParameter(Of Single) = getCommandParameter("brightness")
        If Not IsNothing(param) And param.isSet Then
            Return param.getValue
        Else
            Return param.getDefault
