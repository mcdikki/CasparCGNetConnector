...
Public Class MixerFillCommand
    ...
    Private Sub InitParameter()
        ...
        addParameter(New CommandParameter(Of Single)("x", " The left edge of the new fillSize, 0 = left edge of monitor, 0.5 = middle of monitor, 1.0 = right edge of monitor. Higher and lower values allowed. ", 0, False))
        addParameter(New CommandParameter(Of Single)("y", "The top edge of the new fillSize, 0 = top edge of monitor, 0.5 = middle of monitor, 1.0 = bottom edge of monitor. Higher and lower values allowed.", 0, False))
        addParameter(New CommandParameter(Of Single)("xscale", "The size of the new fillSize, 1 = 1x the screen size, 0.5 = half the screen size. Higher and lower values allowed. ", 1, False))
        addParameter(New CommandParameter(Of Single)("yscale", "The size of the new fillSize, 1 = 1x the screen size, 0.5 = half the screen size. Higher and lower values allowed. ", 1, False))
    ...
    Public Overrides Function getCommandString() As String
        Dim cmd As String = "MIXER " & getDestination(getParameter("channel"), getParameter("layer")) & " FILL"
