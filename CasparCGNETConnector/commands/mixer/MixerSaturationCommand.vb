...
Public Class MixerSaturationCommand
    ...
    Public Sub New(ByVal channel As Integer, ByVal layer As Integer, ByVal saturation As Single, Optional ByVal duration As Integer = 0, Optional ByVal tween As CasparCGUtil.Tweens = CasparCGUtil.Tweens.linear)
        ...
        DirectCast(getParameter("saturation"), CommandParameter(Of Single)).setValue(saturation)
    ...
    Private Sub InitParameter()
        ...
        addParameter(New CommandParameter(Of Single)("saturation", "The saturation value of the layer", 0.0, False))
    ...
    Public Overrides Function getCommandString() As String
        Dim cmd As String = "MIXER " & getDestination(getParameter("channel"), getParameter("layer")) & " SATURATION"

        cmd = cmd & " " & DirectCast(getParameter("saturation"), CommandParameter(Of Single)).getValue
